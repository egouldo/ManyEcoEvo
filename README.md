...
## Accessing analysis datasets (without installing the package)

If you only need the analysis datasets and do not want to install
`ManyEcoEvo::`, you can download them directly from this repository:

- `data-raw/analysis_datasets/blue_tit_data_updated_2020-04-18.csv`:
  <https://github.com/egouldo/ManyEcoEvo/blob/main/data-raw/analysis_datasets/blue_tit_data_updated_2020-04-18.csv>
- `data-raw/analysis_datasets/Euc_data.csv`:
  <https://github.com/egouldo/ManyEcoEvo/blob/main/data-raw/analysis_datasets/Euc_data.csv>
...
package or to download the analysis datasets above. The data processing
and analysis pipeline is optional, and is only needed if you want to
reproduce the dataset generation and analysis in *Gould et al.*
