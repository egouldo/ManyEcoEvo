...
blue_tit_back_transformed <- 
  ...
  ) #TODO transformation column seems wrong! but output from convert_predictions() suggests correct transformation occurred!
...
MA_data_yi <- blue_tit_standardised %>% 
  ...
  pointblank::col_vals_between(columns = "Z", 
                               left = -3, 
                               right = 3, 
                               inclusive = TRUE)
```
