...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.10046153.svg)](https://doi.org/10.5281/zenodo.10046153) [![License: GPL v3](https://img.shields.io/badge/License-GPLv3-blue.svg)](https://www.gnu.org/licenses/gpl-3.0) [![Contributor Covenant](https://img.shields.io/badge/Contributor%20Covenant-2.1-4baaaa.svg)](code_of_conduct.md)
...
[^1]: Gould, E., Fraser, H., Parker, T. *et al.* (2025). Same data, different analysts: Variation in effect sizes due to analytical decisions in ecology and evolutionary biology \[Preprint\]. Ecology and Evolutionary Biology. https://doi.org/10.32942/X2GG62
...
If you only need the analysis datasets and do not want to install `ManyEcoEvo::`, you can download them directly from this repository:

-   `data-raw/analysis_datasets/blue_tit_data_updated_2020-04-18.csv`: <https://github.com/egouldo/ManyEcoEvo/blob/main/data-raw/analysis_datasets/blue_tit_data_updated_2020-04-18.csv>
-   `data-raw/analysis_datasets/Euc_data.csv`: <https://github.com/egouldo/ManyEcoEvo/blob/main/data-raw/analysis_datasets/Euc_data.csv>

You can also find these datasets at the OSF links listed in [`data-raw/analysis_datasets/README.md`](data-raw/analysis_datasets/README.md).

# Regenerating the ManyEcoEvo dataset

You do **not** need to run the local [`targets::`](https://github.com/ropensci/targets) pipeline to use the package or to download the analysis datasets above. The data processing and analysis pipeline is optional, and is only needed if you want to reproduce the dataset generation and analysis in *Gould et al.*.
...
The script that generates datasets used in the `ManyEcoEvo::` package is located in [`ManyEcoEvo/data-raw/tar_make.R`](https://github.com/egouldo/ManyEcoEvo/blob/main/data-raw/tar_make.R).
...
This package is released with a [Contributor Code of Conduct](https://github.com/egouldo/ManyEcoEvo/blob/aa2b9dcb6462f35ce873418e0b9c9697cf0b2f24/CODE_OF_CONDUCT.md).
